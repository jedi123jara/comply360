...
/**
 * /dashboard/configuracion/automatizaciones/workflows
 *
 * Movido desde /dashboard/workflows en la reorganización del sidebar
 * (eliminación del hub IA Laboral). Los workflows son infraestructura de
 * automatización y viven bajo Configuración → Automatizaciones, junto a
 * Agentes IA. La invocación contextual (en Boletas, Contratos, etc.) usa
 * los mismos workflows pero se dispara desde cada módulo de dominio.
 */
