    ...
    <div className="space-y-6 ">
      ...
      <div className="flex items-end justify-between gap-4 pb-4" style={{ borderBottom: '0.5px solid var(--border-default)' }}>
        <div className="flex-1 space-y-2">
          ...
          <div className="h-9 w-96 rounded-lg c360-skeleton" />
          <div className="h-4 w-[500px] rounded c360-skeleton" />
        </div>
      ...
      <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
        {Array.from({ length: 6 }).map((_, i) => (
          ...
          >
            ...
            <div className="h-8 w-20 rounded c360-skeleton" />
      ...
      <div className="flex items-center gap-3">
        <div className="h-10 flex-1 max-w-md rounded-lg c360-skeleton" />
        <div className="h-10 w-24 rounded-lg c360-skeleton" />
      </div>
            ...
            <div key={i} className="px-6 py-4 grid grid-cols-7 gap-4 items-center">
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1.5">
                  <div className="h-3 w-24 rounded c360-skeleton" />
                  <div className="h-2.5 w-16 rounded c360-skeleton" />
                </div>
              </div>
              ...
              <div className="h-3 w-12 rounded c360-skeleton" />
            </div>
          ))}
        </div>
      </div>
