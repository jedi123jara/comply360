    ...
    <AnimatePresence>
      {open && hasSelection && (
        <>
          ...
          />
          {/* LazyMotion local con domMax: el provider global usa domAnimation
              (sin la feature `drag`). Esto habilita el arrastrar-para-cerrar
              solo aquí, sin engordar el bundle global. */}
