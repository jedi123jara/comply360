...
export function CommandPalette({
  ...
  const quickActions: QuickAction[] = useMemo(
    () => [
      ...
      {
        id: 'qa-centro-sunafil',
        label: 'Abrir Centro SUNAFIL',
        hint: 'Diagnóstico · radar · brechas · inspección',
        icon: ShieldCheck,
        perform: () => go('/dashboard/centro-sunafil'),
      },
      {
        id: 'qa-diagnostic',
        label: 'Nuevo diagnóstico SUNAFIL',
        hint: 'Desde Centro SUNAFIL',
        icon: ClipboardList,
        perform: () => go('/dashboard/diagnostico'),
      },
      {
        id: 'qa-simulacro',
        label: 'Simular inspección SUNAFIL',
        hint: 'Ensayo preventivo',
        icon: ShieldAlert,
