    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Strict-Transport-Security', value: 'max-age=63072000; includeSubDomains; preload' },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.clerk.com https://*.clerk.accounts.dev https://clerk.comply360.pe https://*.comply360.pe",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "img-src 'self' data: https: blob:",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://clerk.comply360.pe https://*.comply360.pe https://api.openai.com https://api.groq.com https://api.apis.net.pe https://api-seguridad.sunat.gob.pe https://api.sunat.gob.pe https://api.resend.com",
              "frame-src 'self' https://*.clerk.com https://*.clerk.accounts.dev https://clerk.comply360.pe",
